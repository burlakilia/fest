;(function(){var x=Function('return this')();if(!x.fest)x.fest={};x.fest['spec/templates/each.en_US']=function(__fest_context) {
    "use strict";
    ...
    var i, __fest_iterator0;
    try {
        __fest_iterator0 = itrerate || {};
    } catch (e) {
        __fest_iterator = {};
        __fest_log_error(e.message);
    }
    for (i in __fest_iterator0) {
        ...
        __fest_buf += ("=");
        try {
            __fest_buf += (__fest_escapeHTML(itrerate[i]))
        } catch (e) {
            __fest_log_error(e.message + "4");
        }
    }
